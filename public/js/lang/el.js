...
CKEDITOR.lang["el"] = {
    ...
    common: {
        ...
        invalidLength:
            "Η τιμή που ορίζεται στο πεδίο «%1» πρέπει να είναι θετικός αριθμός με ή χωρίς μονάδα μέτρησης (%2).",
        invalidCssLength:
    ...
    notification: { closed: "Η ειδοποίηση έκλεισε." },
    toolbar: {
    ...
    clipboard: {
        ...
        paste: "Επικόλληση",
        pasteNotification:
            "Πατήστε %1 για επικόλληση. Ο φυλλομετρητής σας δεν υποστηρίζει επικόλληση με το κουμπί της γραμμής εργαλείων ή την επιλογή από το μενού δεξιού κλικ.",
        pasteArea: "Περιοχή Επικόλλησης",
        pasteMsg:
            "Επικολλήστε το περιεχόμενό σας μέσα στην περιοχή παρακάτω και πατήστε Εντάξει.",
    ...
    filetools: {
        loadError: "Παρουσιάστηκε αφάλμα κατά την ανάγνωση αρχείου.",
        networkError: "Παρουσιάστηκε σφάλμα δικτύου κατά την αποστολή αρχείου.",
        httpError404:
            "Παρουσιάστηκε σφάλμα HTTP κατά την αποστολή αρχείου (404: Το αρχείο δεν βρέθηκε).",
        httpError403:
            "Παρουσιάστηκε σφάλμα HTTP κατά την αποστολή αρχείου (403: Απαγορευμένο).",
        httpError:
            "Παρουσιάστηκε σφάλμα HTTP κατά την αποστολή αρχείου (κατάσταση σφάλματος: %1).",
        noUrlError: "Η διεύθυνση URL δεν έχει οριστεί.",
        responseError: "Λανθασμένη απάντηση διακομιστή.",
    },
    format: {
        label: "Μορφοποίηση",
