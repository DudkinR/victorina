...
$(document).ready(function() {
  ...
  $('.answer-btn').click(function() {
    ...
    var adjustedResult = result + (selectedCorrectButtons / correctButtons) - (selectedIncorrectButtons / totalButtons);

    if (selectedCorrectButtons > 0 && adjustedResult > 0) {
      if (selectedCorrectButtons === correctButtons) {
        setTimeout(function() {
          window.location.href = '/vict2?page=' + nextPage + '&r=' + adjustedResult+'&topic={{$topic->id}}';
        }, 3000);
      }
    }
  });
