...
(function () {
    ...
    function t(a) {
        return function () {
            var b = this.getValue(),
                b = !!(
                    CKEDITOR.dialog.validate.integer().call(this, b) && 0 < b
                );
            ...
            onLoad: function () {
                ...
                if (a)
                    a.on("change", function () {
                        ...
                        (d = e.getContentElement("info", "txtHeight")) &&
                            d.setValue(a, !0);
                    });
            },
            onShow: function () {
                ...
                "tableProperties" == b &&
                    ((e = e.getSelectedElement()) && e.is("table")
                        ...
                        : 0 < l.length &&
                          (CKEDITOR.env.webkit &&
                              l[0].shrink(CKEDITOR.NODE_ELEMENT),
                          (c = a
            ...
            onOk: function () {
                ...
                if (d.info) {
                    ...
                    if (!c.$.tHead && ("row" == b || "both" == b)) {
                        ...
                        f ||
                            ((f = new CKEDITOR.dom.element("thead")),
                            f.insertBefore(g));
